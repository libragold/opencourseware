...
2 chalkboard presentations worth 20% each, 1 slides presentation 15%, 2 <del>in-class</del> take-home midterms 10% each, and the term paper 25%.

_Attendance policy:_ Without a valid excuse such as illness, failure to show up at one’s own talk or missing more than 3 classes results an immediate failure.
...
| 4/20 | *No class (Patriots' Day)* | 4/22 | Brian Gu<br />Luis Garcia<br />William Nash |
