...
Also we covered an elegant proof of Fermat&#8217;s little theorem. In that proof, we considered two <a title="Reduced residue system" href="http://en.wikipedia.org/wiki/Reduced_residue_system" target="_blank">reduced residue systems</a>, $1, 2, \ldots, p-1$ and $a, 2a, \ldots, (p-1)a$. Since they are both reduced residue systems, the products should be the same in modulo $p$ arithmetic. Hence $(p-1)!\equiv (p-1)!a^{p-1} \mod p$.
