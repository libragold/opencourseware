...
Basic exercises that give students hunches how informal languages, for instance daily use of English, can be translated to the formal language in [first order logic][1], and vice versa.
...
Common Mistakes:
 ...
 [1]: http://en.wikipedia.org/wiki/First-order_logic
