...
Common Mistakes:
  ...
  * In problem I, some students switched Completeness and Soundness in their answers. Roughly speaking, [completeness][1] means nothing needs to be added to it, while [soundness][2] means axioms are all valid and rules having the property of preserving truth.
 ...
 [1]: http://en.wikipedia.org/wiki/Completeness
